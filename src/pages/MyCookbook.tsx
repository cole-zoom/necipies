...
export function MyCookbook() {
  ...
  const { recipes, loading } = useRecipes({ authorId: user?.id ?? null, limit: 100 });
  ...
  if (!user) {
    return (
      <div className="container py-16 max-w-md text-center">
        ...
        <h1 className="font-serif text-3xl tracking-tight">Your private shelf</h1>
  ...
  return (
    <div className="container py-8 sm:py-12">
      <div className="flex items-end justify-between gap-3 mb-6 animate-fade-in">
        <div>
          <h1 className="font-serif text-3xl sm:text-4xl tracking-tight">My cookbook</h1>
